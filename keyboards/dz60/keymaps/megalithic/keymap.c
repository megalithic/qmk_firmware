...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_BASE] = LAYOUT_all(
        ...
        LT(KC_F19, KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLS,
        ...
        MO(_FN), KC_LALT, KC_LGUI, LT(_FN, KC_SPC), LT(KC_F19, KC_SPC), KC_SPC, KC_RGUI, MO(_ARROWS), KC_LEFT, KC_DOWN, KC_RIGHT),
