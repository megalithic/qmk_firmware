...
#define WB A(KC_LEFT) // FIXME
#define WF A(KC_RIGHT) // FIXME
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
     ...
     // KC_GRV, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MINS, KC_EQL, KC_BSPC, KC_BSPC,
    [_BASE] = LAYOUT_all(
        KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC, KC_BSPC,
        LT(_FN, KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLS,
        CTRL_ESC, KC_A, KC_S, KC_D, LT(_FN, KC_F), KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,
        KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_DEL,
        MO(_FN), KC_LALT, KC_LGUI, KC_SPC, KC_F19, KC_SPC, KC_RGUI, MO(_ARROWS), KC_LEFT, KC_DOWN, KC_RIGHT),
    ...
    */
    [_ARROWS] = LAYOUT_all(
        ...
        _______, WF,      _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_MRWD, KC_MFFD, KC_MPLY,
    ...
    */
    [_HDUE] = LAYOUT_all(
        ...
        _______, DWF,     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
