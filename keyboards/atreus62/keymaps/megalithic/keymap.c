...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
    ...
    MG_FN,          KC_TRNS, KC_TRNS, KC_LALT, KC_LGUI, MG_FN, KC_F19,     KC_ENT,      KC_SPC,  KC_SPC,   KC_DEL,  KC_TRNS, KC_TRNS, KC_RGUI
  ),
  ...
  [_FN] = LAYOUT(
    ...
    KC_TRNS,        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  MG_RESET,    KC_BSPC, KC_BSPC,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
  ),
