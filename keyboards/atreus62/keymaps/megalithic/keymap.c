...
#define MG_WB       A(KC_LEFT) // FIXME
#define MG_WF       A(KC_RIGHT) // FIXME
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
    ...
    MO(_FN),        KC_LBRC, KC_LALT, KC_LGUI, MO(_FN), KC_BSPC, KC_F19,   KC_ENT,      KC_SPC,  KC_SPC,  KC_EQL,  KC_DEL,  KC_RBRC, KC_RGUI
  ),
